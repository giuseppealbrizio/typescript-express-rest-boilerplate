 ...
 */
export const keyValuesArrayToObject = (keyValuesArray: Array<any>) => {
  _.reduce(
    keyValuesArray,
    (result, item) => {
 ...
 * @param valuesArray
 */
export const valuesArrayToObject = (valuesArray: Array<any>) => {
  _.reduce(
    valuesArray,
 ...
 * @returns boolean
 */
export const checkElementsBetweenArray = (
